...
type SessionManager struct {
	...
	log           *slog.Logger
	maxCalls      int
	recordingsDir string // diretório dos WAVs de gravação ("" desabilita)
...
func newSessionManager(ctx context.Context, container *sqlstore.Container, broker *Broker, store *sessionStore, waLogger waLog.Logger, log *slog.Logger, maxCalls int, recordingsDir string) *SessionManager {
