...
export const eventTypes = ['system.connected','session.status.changed','session.qr.updated','message.received','message.sent','message.status.updated','conversation.updated','conversation.management.updated','conversation.context.updated','conversation.sync.updated','worker.error'] as const;
