export type RealtimeEvent = { eventType: 'system.connected' | 'session.status.changed' | 'message.received' | 'message.sent' | 'conversation.updated' | 'conversation.management.updated' | 'conversation.context.updated' | 'conversation.sync.updated' | 'conversation.kanban.moved' | 'kanban.stage.created' | 'kanban.stage.updated' | 'kanban.stage.reordered' | 'workspace.user.created' | 'workspace.user.updated' | 'workspace.team.created' | 'workspace.team.updated' | 'workspace.team.members.updated' | 'routing.queue.created' | 'routing.queue.updated' | 'routing.queue.members.updated' | 'conversation.routing.updated'; workspaceId: string; payload: Record<string, unknown> };
