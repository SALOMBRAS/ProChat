...
export type GroupParticipant = { whatsappId: string; name: string | null; phone: string | null; role: string | null; avatarUrl: string | null; lastActiveAt: string | null };
...
export class InboxApi {
  ...
  sendMessage=(id:string,text:string,mentions?:string[])=>this.http.post<InboxMessage>(`/api/v1/inbox/conversations/${encodeURIComponent(id)}/messages`, { text, ...(mentions?.length ? { mentions } : {}) });
