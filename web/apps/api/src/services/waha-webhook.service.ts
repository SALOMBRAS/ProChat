...
export type IngestResult = { duplicate: boolean; messageInserted: boolean; messageType?: string; conversationId?: string; messageId?: string; conversationChatId?: string; conversationType?: 'direct' | 'group'; senderWhatsappId?: string | null; direction?: 'inbound' | 'outbound'; historical?: boolean; technical?: boolean; quarantined?: boolean; lastMessageAt?: string | null };
