...
export class WahaProvider implements WhatsAppProvider {
  ...
  readonly capabilities = ['health', 'sessions', 'status', 'sendMessage', 'sendMedia', 'contacts', 'groups', 'reactions', 'history'] as const;
