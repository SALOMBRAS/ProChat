...
describe('WhatsAppSessionManager', () => {
  ...
  beforeEach(async () => {
    ...
    config = { name: 'test', dataDir, connectionEnabled: true, demoMode: false, maxReconnectAttempts: 2, reconnectBaseDelayMs: 10, qrTtlMs: 100, internalTransportPort: 3101, whatsAppProvider: 'baileys', wahaBaseUrl: 'http://127.0.0.1:3002', wahaTimeoutMs: 1_000, gowaEnabled: false, gowaBaseUrl: 'http://127.0.0.1:3000', gowaTimeoutMs: 1_000 };
